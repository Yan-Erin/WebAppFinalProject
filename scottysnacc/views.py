...
def add_action(request):
    ...
    event.startdate = datetime.strptime(request.POST['start'], '%Y/%m/%d %H:%M').replace(tzinfo=pytz.timezone('US/Eastern')).isoformat()
event.enddate = datetime.strptime(request.POST['end'], '%Y/%m/%d %H:%M').replace(tzinfo=pytz.timezone('US/Eastern')).isoformat()
