...
SOCIAL_AUTH_PIPELINE = (
    ...
    'scottysnacc.custom_pipeline.check_email_domain',  # Add the custom pipeline function
...
SCOTTYSNACC_USERS = CONFIG.get("ScottySnacc", "users")
...
STATIC_URL = '/static/'
STATICFILES_DIRS=[os.path.join(BASE_DIR, 'scottysnacc/static')]
